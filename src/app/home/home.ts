        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div class="grid md:grid-cols-4 gap-8">
            ...
            <div class="md:col-span-2">
              <h3 class="text-2xl font-bold text-white mb-4">Gopi</h3>
              ...
              <div class="flex space-x-4">
                <a href="https://www.linkedin.com/in/p-gopinath/" target="_blank" rel="noopener noreferrer"
                   class="w-10 h-10 bg-slate-800 hover:bg-blue-500/20 rounded-lg flex items-center justify-center text-gray-400 hover:text-blue-400 transition-colors duration-300">
            ...
            <div>
              ...
              <ul class="space-y-2">
                <li><a href="#hero" class="text-gray-400 hover:text-blue-400 transition-colors duration-300">Home</a></li>
            ...
            <div>
              ...
              <ul class="space-y-2">
                <li class="text-gray-400">
                  <a href="mailto:p.gopinath.work@gmail.com" class="hover:text-blue-400 transition-colors duration-300">
                    p.gopinath.work@gmail.com
                  </a>
                </li>
                <li class="text-gray-400">
                  <a href="tel:+916369327257" class="hover:text-blue-400 transition-colors duration-300">
                    +91 6369 327 257
                  </a>
                </li>
                <li class="text-gray-400">Chennai, India</li>
              </ul>
            </div>
          </div>
          ...
          <div class="border-t border-slate-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p class="text-gray-400 text-sm">
              © {{ currentYear }} Gopi. All rights reserved.
            </p>
