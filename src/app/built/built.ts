...
@Component({
  ...
  template: `
    <section id="built" class="relative py-24 md:py-32" aria-labelledby="built-heading">
      <div class="max-w-7xl mx-auto px-6 md:px-10">
        <!-- Header -->
        <div appReveal class="grid grid-cols-1 md:grid-cols-12 gap-8 mb-12">
          <div class="md:col-span-6">
            <span class="eyebrow">02 · Systems</span>
            <h2 id="built-heading" class="mt-4 font-display text-5xl md:text-6xl font-bold leading-none">
              Things I've <span class="text-coral italic">built.</span>
            </h2>
          </div>
          <div class="md:col-span-5 md:col-start-8 self-end">
            <p class="text-mist leading-relaxed">
              Some of the systems I've built and reused across products. Listed by
